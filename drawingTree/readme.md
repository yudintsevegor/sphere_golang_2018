...
* если вы столкнётесь с несовместимостью os.File и bytes.Buffer - смотрите видео "Написание тестов для программы уникализации" из 1-й лекции, uniq/wint_tests в коде в уроку, а так же ссылку на хабр ниже
